...
namespace apidotnet.Data.Migrations
{
    ...
    [Migration("20260819121527_AddSales")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Data.Entities.BuyCycle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal?>("BorderVatRate")
                        .HasPrecision(9, 4)
                    ...
                    b.Property<decimal?>("MarkupCoefficient")
                        .HasPrecision(9, 4)
                        .HasColumnType("decimal(9,4)");
            ...
            modelBuilder.Entity("Data.Entities.FactorySheet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTimeOffset?>("SheetDate")
                        .HasColumnType("datetimeoffset");
            ...
            modelBuilder.Entity("Data.Entities.OperatingExpense", b =>
                {
                    ...
                    b.Property<string>("SubmittedByUpn")
                        .HasMaxLength(320)
                        .HasColumnType("nvarchar(320)");
                    ...
                    b.HasIndex("CategoryKey", "SpentAt");
            ...
            modelBuilder.Entity("Data.Entities.PurchaseLot", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Data.Entities.Shipment", b =>
                {
                    ...
                    b.Property<decimal?>("ImportVatPaid")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<string>("OtherCostsNote")
                        .HasMaxLength(400)
                        .HasColumnType("nvarchar(400)");
                    ...
                    b.Property<decimal?>("UsdToEurRate")
                        .HasPrecision(18, 6)
            ...
            modelBuilder.Entity("Data.Entities.Target", b =>
                {
                    ...
                    b.HasIndex("PeriodType", "MetricKey", "Year", "Month", "BuyCycleId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Data.Entities.PurchaseLot", b =>
                {
                    b.HasOne("Data.Entities.ProductModel", "ProductModel")
                        .WithMany("Lots")
            ...
            modelBuilder.Entity("Data.Entities.Sale", b =>
                {
                    ...
                    b.HasOne("Data.Entities.PurchaseLot", "PurchaseLot")
                        .WithMany("Sales")
                        .HasForeignKey("PurchaseLotId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("Customer");

                    b.Navigation("PurchaseLot");
                });
