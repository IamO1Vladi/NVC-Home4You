...
public class EnvConfig
{
    ...
    // The billing tables (ROADMAP #21). DEFAULTED rather than blank, unlike every getter
    // above, because these exist only for the one-shot import: the ids were read from the
    // live app on 2026-08-19 and are recorded in ROADMAP.md. Overridable all the same.
    public string TableBuyCycles => _cfg["QB_TABLE_BUY_CYCLES"] ?? "bvuz3dthx";
    public string TableShipments => _cfg["QB_TABLE_SHIPMENTS"] ?? "bvuz3mm8e";
