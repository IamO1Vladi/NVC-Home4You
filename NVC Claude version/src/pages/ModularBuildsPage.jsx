        ...
        <div className="container mb-hero-grid">
          ...
          <div className="mb-hero-visual">
            <img
              ...
              src={cdnImage(content.heroImage, { width: 800 })}
              srcSet={cdnSrcSet(content.heroImage, [400, 600, 800, 1100])}
          ...
          {products.map((product) => (
            ...
            >
              <img
                ...
                src={cdnImage(product.image, { width: 960 })}
                srcSet={cdnSrcSet(product.image, [480, 720, 960, 1280])}
