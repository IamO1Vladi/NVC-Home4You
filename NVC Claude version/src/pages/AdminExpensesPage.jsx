...
const TEXT = {
  bg: {
    ...
    updated: 'Запазено',
    categories: {
      salaries: 'Заплати', rent: 'Наем', 'transport-fuel': 'Транспорт и гориво',
      marketing: 'Реклама', utilities: 'Ток, вода, интернет',
      'tools-equipment': 'Инструменти и оборудване', 'fees-taxes': 'Такси и данъци',
      other: 'Друго',
    },
  },
  en: {
    ...
    updated: 'Saved',
    categories: {
      salaries: 'Salaries', rent: 'Rent', 'transport-fuel': 'Transport & fuel',
      marketing: 'Marketing', utilities: 'Utilities',
      'tools-equipment': 'Tools & equipment', 'fees-taxes': 'Fees & taxes',
      other: 'Other',
    },
  },
}
